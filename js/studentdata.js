	...
	students : [
		{
			name : "Alicia", 
			surname: "Soto",
			thumbnail : "images/alicia_soto/photo.jpg",
			status : 'Esperando respuesta de Profesor Revisor <ion-icon name="time-outline" class="mr-2 lead text-orange"></ion-icon>',
			cohort: "2016",
			curriculum: "ICC110-2014",
			career: "Ingeniería Civil en Computación e Informática",
			companies: "Consultoría Roboc",
			contactinfo : {
				phone : "+56912345678",
				email : "alicia.soto@mayor.cl"
			},
			projects : [
				{	
					src : "images/alicia_soto/1.jpg",
					course : "[2019-02] Proyecto de Ingeniería I", 
					title : "Automatización de procesos en empresa consultora",
					status: "Aprobado",
					bscolor: "success",
					academic: "Lorena Soto",
					revisor: "Nina Valdivia",
					future: "Continúa a Proyecto de Ingeniería II",
				...
				{	
					...
					course : "[2020-01] Proyecto de Ingeniería II", 
					title : "Bot para automatizar procesos en empresa consultora",
					status: "Aprobado",
					bscolor: "success",
					academic: "Lorena Soto",
					revisor: "Nina Valdivia",
					future: "Continúa a Proyecto Aplicado de Título.",
				...
				{	
					...
					course : "[2020-02] Proyecto Aplicado de Título", 
					title : "Implementación de bot que automatiza procesos en empresa consultora",
					status: "Pendiente",
					bscolor: "warning",
					academic: "Lorena Soto",
					revisor: "Nina Valdivia",
		...
		},
		{
			name : "Carlos", 
			surname: "Pérez",
			thumbnail : "images/carlos_perez/photo.jpg",
			status : 'No ha entregado tesis <ion-icon name="alert-outline" class="mr-2 lead text-danger"></ion-icon>',
			cohort: "2013",
			curriculum: "ICC110-2009",
			companies: "Fundación Gatitos y Mapcity",
			career: "Ingeniería Civil en Computación e Informática",
			contactinfo : {
				phone : "+56987654321",
				email : "carlos.perez@mayor.cl"
			},
			projects : [
				{	
					src : "images/carlos_perez/1.jpg",
					course : "[2019-01] Proyecto de Ingeniería I", 
					title : "Aplicación para alimentar gatitos de la calle",
					status: "Rechazado",
					bscolor: "danger",
					academic: "Lorena Soto",
					revisor: "Nina Valdivia",
					future: "No tiene la dificultad necesaria para ser un proyecto de ingeniería.",
				...
				{	
					...
					course : "[2019-02] Proyecto de Ingeniería I (2do intento)", 
					title : "Aplicación para encontrar tiendas abiertas durante un toque de queda",
					status: "Aprobado",
					bscolor: "success",
					academic: "Lorena Soto",
					revisor: "Nina Valdivia",
				...
				{	
					...
					course : "[2020-01] Proyecto de Ingeniería II", 
					title : "Aplicación Android de búsqueda de tiendas abiertas durante la pandemia",
					status: "Aprobado",
					bscolor: "success",
					academic: "Lorena Soto",
					revisor: "Nina Valdivia",
                ...
                {	
					...
					course : "[2020-02] Proyecto Aplicado de Título", 
					title : "Directorio digital de tiendas abiertas durante situaciones de emergencia para teléfonos inteligentes",
					status: "Atrasado",
					bscolor: "info",
					academic: "Lorena Soto",
					revisor: "Nina Valdivia",
		...
		},
		{
			name : "Daniela", 
			surname: "Riquelme",
			thumbnail : "images/daniela_riquelme/photo.jpg",
			status : 'Egresada <ion-icon name="school-outline" class="mr-2 lead"></ion-icon>',
			cohort: "2016",
			curriculum: "ICE110-2014",
			companies: "Facebook",
			career: "Ingeniería en Computación e Informática",
			contactinfo : {
				phone : "+56911111111",
				email : "daniela.riquelme@mayor.cl"
			},
			projects : [
				{	
					src : "images/daniela_riquelme/1.jpg",
					course : "[2019-01] Proyecto de Ingeniería I", 
					title : "Aplicación de realidad aumentada en el contexto empresarial",
					status: "Aprobado",
					bscolor: "success",
					academic: "Yuri Caceres",
					revisor: "Julian Gil",
					future: "Continúa a Proyecto de Ingeniería II Vespertino.",
				...
				{	
					...
					course : "[2019-02] Proyecto de Ingeniería II", 
					title : "Software de realidad aumentada para mejora de procesos de diseño industrial",
					status: "Aprobado",
					bscolor: "success",
					academic: "Yuri Caceres",
					revisor: "Julian Gil",
					future: "Pasa a proceso de titulación.",
		...
		},
		{
			name : "Pedro", 
			surname: "Jimenez",
			thumbnail : "images/pedro_jimenez/photo.jpg",
			status : "Debe inscribir Proyecto de Ingeniería II.",
			cohort: "2018",
			curriculum: "ICC110-2018",
			career: "Ingeniería Civil en Computación e Informática",
			companies: "Falabella",
			contactinfo : {
				phone : "+5611111111",
				email : "pedro.jimenez@mayor.cl"
			},
			projects : [
				{	
					src : "images/pedro_jimenez/1.jpg",
					course : "[2020-02] Proyecto de Ingeniería I", 
					title : "Sistema de gestión de productos ingresados al servicio técnico de electrodomésticos",
					status: "Aprobado",
					bscolor: "success",
					academic: "Humberto Vélez",
					revisor: "Sebastián Díaz",
					future: "Puede continuar a Proyecto de Ingeniería II.",
		...
		},
		{
			name : "Esteban", 
			surname: "Dido",
			thumbnail : "images/esteban_dido/photo.jpg",
			status : 'Expulsado por no pago de arancel <ion-icon name="close-circle-outline" class="mr-2 lead text-danger"></ion-icon>',
			cohort: "2017",
			curriculum: "ICC110-2014",
			companies: "Asesorías Rafael Garay",
			career: "Ingeniería Civil en Computación e Informática",
			contactinfo : {
				phone : "+56911111111",
				email : "esteban.dido@mayor.cl"
			},
			projects : [
				{	
					src : "images/esteban_dido/1.jpg",
					course : "[2020-02] Proyecto de Ingeniería I", 
					title : "Compra automática de criptomonedas para pequeñas y medianas empresas",
					status: "Rechazado",
					bscolor: "danger",
					academic: "Juanito Perez",
					revisor: "Pepito Perez",
					future: "No se puede mejorar, expulsaron al estudiante.",
		...
		},
		{
			name : "Natalia", 
			surname: "Dominguez",
			thumbnail : "images/natalia_dominguez/photo.jpg",
			status : "Debe enviar informe de Proyecto de Ingeniería I",
			cohort: "2019",
			curriculum: "ICC110-2018",
			career: "Ingeniería en Informática (Prosecución de estudios)",
			companies: "Banco de Crédito e Inversiones",
			contactinfo : {
				phone : "+56971111111",
				email : "natalia.dominguez@mayor.cl"
			},
			projects : [
				{	
					src : "images/natalia_dominguez/1.jpg",
					course : "[2020-02] Proyecto de Ingeniería I", 
					title : "Aplicación de metodologías para robustecer la ciberseguridad en empresa bancaria",
					status: "Pendiente",
					bscolor: "warning",
					academic: "Lorena Galeazzi",
					revisor: "Claudia Fehring",
